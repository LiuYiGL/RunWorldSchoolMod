...
public class Constant {
    ...
    public static class string {
        ...
        public static final String USE_GUIDE = "欢迎使用本模块！\n此版本只支持《运动世界校园》v5.1.3，其他版本请勿启用该模块，否则可能会导致APP无法打开，必须清除APP数据才能恢复。\n\n<<使用说明>>\n1. 当【取消夜间跑步限制】时会默认使用[无序]点位，可通过【跑步模式】修改。\n2. 【关闭定位信息检测】或【关闭点位信息检测】可在GPS信号差时使用，后者效果更强，建议前者足以。\n\n<<注意事项>>\n1. 该Xposed模块由@LiuYi_GL编写，感谢由@KyuubiRan提供的EzXHelper工具库。\n2. 该模块完全免费，如果您是通过付费方式获取该模块，请您和商家对线（制作不易，要不就给作者打赏一点？）。\n3. 如果因您使用该模块导致任何后果与作者无关，最终解释权归作者所有（总不能让我去刚老师吧。。）。\n4. 仅供学习交流使用，下载后请于24小时后删除本模块，禁止一切商业用途。（客套话，爱删不删吧，就是不能拿去赚马内，除非给作者分点）\n";
